...
res.write("<h1 style='color:blue;position: relative;left: 40%;'>User Submiteddetails</h1>")
res.write("<table border=1 cellspacing=0 style='color:blue; position:relative;left: 35%; width:450px;'>")
res.write("<tr><td style='padding:10px;'> Name </td><tdstyle='padding:10px;'>" +inputdata.get('name') + '</td></tr>');
